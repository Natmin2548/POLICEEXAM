...
function buildThaiPrompt({ count, subcategory, title, contextText }) {
  return `คุณคือผู้เชี่ยวชาญระดับปรมาจารย์ในการออกข้อสอบวิชา "ภาษาไทย" (ตามมาตรฐานข้อสอบบรรจุเข้ารับราชการ และข้อสอบ ก.พ. ภาค ก.)
โปรดสร้างข้อสอบภาษาไทยระดับพรีเมียมจำนวน ${count} ข้อ ${subcategory ? `เน้นหัวข้อ/บทเรียน: "${subcategory}"` : ''} ${title ? `ชื่อชุดข้อสอบ: "${title}"` : ''}
...
3. ❌ **ห้ามออกคำถามถามแต่นิยามทฤษฎีแห้งๆ** เช่น "บรรยายโวหารคืออะไร?", "อุปมาโวหารหมายถึงอะไร?", "ประโยคความซ้อนคืออะไร?" (ห้ามถามนิยามตรงๆ เด็ดขาด)

📖 รูปแบบข้อสอบภาษาไทยตามมาตรฐานข้อสอบจริง (ต้องมีบทความ/ข้อความตัวอย่าง 100%):
1. **หมวดโวหารการเขียน (บรรยายโวหาร, พรรณนาโวหาร, เทศนาโวหาร, สาธกโวหาร, อุปมาโวหาร)**:
   - คุณต้อง **แต่งบทความสั้น/ข้อความตัวอย่าง 2-4 บรรทัด** เช่น บรรยายการเดินทาง/วิถีชีวิตชาวบ้าน (บรรยายโวหาร), พรรณนาทิวทัศน์ธรรมชาติ/แสงแดดยามเช้าและสายน้ำ (พรรณนาโวหาร), ข้อคิดคำสอนเรื่องความเพียร/ความกตัญญู (เทศนาโวหาร), หรือยกนิทานอุทาหรณ์ (สาธกโวหาร)
   - ตั้งคำถาม เช่น:
     *"ข้อความข้างต้นใช้โวหารการเขียนประเภทใดเป็นหลัก?"*
     *"ข้อความใดต่อไปนี้ใช้โวหารการเขียนประเภทเดียวกับข้อความข้างต้น?"*
2. **หมวดโวหารภาพพจน์ (อุปมา, อุปลักษณ์, บุคคลวัต/บุคคลสมมุติ, สัทพจน์, อธิพจน์, สัญลักษณ์, นามนัย)**:
   - คุณต้อง **แต่งหรือยกตัวอย่างวรรคทอง ร้อยกรอง หรือร้อยแก้วเปรียบเทียบ** ในโจทย์ แล้วให้นักเรียนวิเคราะห์ เช่น:
     *"ข้อความใดต่อไปนี้ใช้โวหารภาพพจน์ประเภท 'บุคคลวัต' (Personification)?"*
     *"'สายฝนโปรยปรายราวกับหยาดน้ำตาแห่งฟ้า คลื่นซัดสาดซ่ากระทบฝั่ง' ข้อความนี้เด่นด้วยโวหารภาพพจน์ประเภทใด?"*
     *"ข้อใดใช้โวหารภาพพจน์ประเภท 'อุปลักษณ์'?"*
     *"ข้อใดมีโวหารภาพพจน์ต่างจากข้ออื่น?"*
3. **หมวดการจับใจความสำคัญและวิเคราะห์บทความ (Reading Comprehension)**:
   - คุณต้อง **แต่งบทความสารคดีหรือบทความทั่วไปขนาด 3-5 บรรทัด** (เรื่องสิ่งแวดล้อม, พฤติกรรมมนุษย์, สุขภาพ, การใช้ชีวิต, วัฒนธรรม)
   - ตั้งคำถาม เช่น:
     *"ใจความสำคัญของบทความข้างต้นคือข้อใด?"*
     *"ข้อความข้างต้นผู้เขียนมีเจตนาตามข้อใดเป็นสำคัญ?"*
     *"ข้อใดเป็นสาระสำคัญหรือข้อคิดที่ได้จากบทความข้างต้น?"*
     *"จากบทความข้างต้น สามารถอนุมานได้ตามข้อใด?"*
4. **หมวดระดับภาษา (ภาษาทางการ, กึ่งทางการ, ภาษาปาก/ไม่เป็นทางการ)**:
   - ยกตัวอย่างประโยคจริงครบทั้ง 4 ตัวเลือก แล้วถามการจำแนกระดับภาษา
5. **หมวดโครงสร้างประโยค (ประโยคความเดียว, ความรวม, ความซ้อน, ประโยคบกพร่อง/กำกวม/ฟุ่มเฟือย)**:
   - แต่งประโยคตัวอย่างครบ 4 ตัวเลือก แล้วถามการจำแนกชนิดประโยค
6. **หมวดการสะกดคำ การใช้คำ และราชาศัพท์**:
   - ยกประโยคบริบทจริงที่มีการใช้คำ หรือถามคำที่สะกดถูกต้อง/ผิดตามพจนานุกรม ฉบับราชบัณฑิตยสถาน
...
[
  {
    "questionText": "ข้อความ:\n\"...แต่งบทความ/ข้อความตัวอย่าง 2-4 บรรทัด (ไม่ระบุคำว่าตำรวจ)...\"\n\nจากข้อความข้างต้น ...คำถาม...",
    "optionA": "ตัวเลือก ก",
    "optionB": "ตัวเลือก ข",
    "optionC": "ตัวเลือก ค",
    "optionD": "ตัวเลือก ง",
    "correctOption": "A",
    "explanation": "คำอธิบายเฉลยอย่างละเอียด อ้างอิงหลักภาษาไทยและการวิเคราะห์ข้อความ..."
  }
]`;
}
