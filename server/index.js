...
app.post('/api/admin/exams/preview-ai', authenticateToken, async (req, res) => {
  try {
    ...
    } else if (combinedStr.includes('โอเปเรชั่น') || combinedStr.includes('iq') || combinedStr.includes('operation')) {
      topicInstruction = 'คำแนะนำพิเศษ: ข้อสอบเรื่อง "โอเปเรชั่น (Operations)" และ "IQ การฝึกคิดทั่วไป" สำหรับสอบตำรวจ เน้นโจทย์ตัวดำเนินการทางคณิตศาสตร์แบบนิยามสัญลักษณ์ เช่น กำหนดให้ a * b = (a + b) x 2 หรือ a @ b = a² - b + 3 แล้วถามค่าของ x * y รวมถึงโจทย์ปัญหาเชาว์ปัญญา IQ ฝึกการคิดวิเคราะห์เชิงตัวเลข 4 ตัวเลือก พร้อมอธิบายขั้นตอนและสูตรการคิดใน explanation';
    } else if (combinedStr.includes('เลขพื้นฐาน') || combinedStr.includes('กฎของเลข')) {
      topicInstruction = 'คำแนะนำพิเศษ: ข้อสอบเรื่อง "เลขพื้นฐานและกฎของเลขทั่วไป" สำหรับสอบตำรวจ เน้นกฎและลำดับการคำนวณทางคณิตศาสตร์ (Order of Operations: วงเล็บ, ยกกำลัง, คูณ/หาร, บวก/ลบ เช่น 14 * 20 - (200 / 5) หรือการกระจายพจน์ และสมบัติของจำนวนจริง) 4 ตัวเลือก พร้อมแสดงวิธีคิดคำนวณทีละขั้นอย่างละเอียดใน explanation';
