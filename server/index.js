...
function buildThaiPrompt({ count, subcategory, title, contextText }) {
  return `คุณคือผู้เชี่ยวชาญระดับปรมาจารย์ในการออกข้อสอบวิชา "ภาษาไทย" สำหรับการสอบคัดเลือกข้าราชการตำรวจ (กองการสอบ กองบัญชาการศึกษา ทั้งสายอำนวยการและสายปราบปราม)
โปรดสร้างข้อสอบภาษาไทยระดับคุณภาพสูงจำนวน ${count} ข้อ ${subcategory ? `เน้นหัวข้อ/บทเรียน: "${subcategory}"` : ''} ${title ? `ชื่อชุดข้อสอบ: "${title}"` : ''}
${contextText ? `คลังเนื้อหาอ้างอิง:\n${contextText.substring(0, 16000)}\n\n` : ''}

🚨 ข้อกำหนดและมาตรฐานสำคัญสูงสุดในการออกข้อสอบภาษาไทย (ห้ามถามแต่นิยามทฤษฎีเด็ดขาด):
1. ❌ **ห้ามออกคำถามถามแต่นิยามทฤษฎีแห้งๆ**:
   - ห้ามถามแบบ "บรรยายโวหารคืออะไร?", "อุปมาโวหารหมายถึงอะไร?", "ระดับภาษาทางการหมายถึงอะไร?", "ประโยคความซ้อนคืออะไร?" (ห้ามถามความหมายตรงๆ เด็ดขาด)
2. 📖 **ต้องมีบทความ ข้อความสั้น หรือตัวอย่างประโยคจริง 100% ให้นักเรียนได้อ่านวิเคราะห์**:
   - **กรณีเรื่อง "โวหารการเขียน" (บรรยาย, พรรณนา, เทศนา, สาธก, อุปมาโวหาร)**:
     - คุณต้อง **แต่งบทความสั้น/ข้อความตัวอย่าง 2-4 บรรทัด** ในโจทย์ เช่น ยกข้อความบรรยายเหตุการณ์ตำรวจเข้าช่วยเหลือประชาชน, ข้อความพรรณนาทัศนียภาพธรรมชาติ, หรือข้อความเทศนาอบรมคุณธรรม แล้วตั้งคำถาม เช่น:
       *"ข้อความข้างต้นใช้โวหารการเขียนประเภทใดเป็นหลัก?"*
       *"ข้อความใดต่อไปนี้ใช้โวหารการเขียนประเภทเดียวกับข้อความข้างต้น?"*
   - **กรณีเรื่อง "โวหารภาพพจน์" (อุปมา, อุปลักษณ์, บุคคลวัต/บุคคลสมมุติ, สัทพจน์, อธิพจน์, อวพจน์, นามนัย, สัญลักษณ์, ปฏิทรรศน์)**:
     - คุณต้อง **แต่งหรือยกตัวอย่างข้อความ ร้อยกรอง หรือประโยคเปรียบเทียบ** ในโจทย์ แล้วให้นักเรียนวิเคราะห์ เช่น:
       *"ข้อความใดต่อไปนี้ใช้โวหารภาพพจน์ประเภท 'บุคคลวัต' (Personification)?"*
       *"'เสียงปืนดังกึกก้องกัมปนาท คลื่นลมคำรามซัดสาดชายหาดอย่างบ้าคลั่ง' ข้อความนี้เด่นด้วยโวหารภาพพจน์ประเภทใด?"*
       *"ข้อใดใช้โวหารภาพพจน์ประเภท 'อุปมา' ได้อย่างชัดเจน?"*
       *"ข้อใดมีโวหารภาพพจน์ต่างจากข้ออื่น?"*
   - **กรณีเรื่อง "การจับใจความสำคัญ / วิเคราะห์บทความ" (Reading Comprehension)**:
     - คุณต้อง **แต่งบทความขนาด 3-5 บรรทัด** (เกี่ยวกับสังคม, ข่าวสาร, วิถีชีวิต, ปรัชญา, การทำงานของตำรวจ หรือข้อคิดเตือนใจ) แล้วตั้งคำถามวิเคราะห์ เช่น:
       *"ใจความสำคัญของบทความข้างต้นคือข้อใด?"*
       *"ข้อความข้างต้นผู้เขียนมีเจตนาตามข้อใดเป็นสำคัญ?"*
       *"ข้อใดเป็นสาระสำคัญ/ข้อคิดที่ได้จากบทความข้างต้น?"*
       *"จากบทความข้างต้น ข้อความใดสอดคล้อง/ไม่สอดคล้องกับเนื้อเรื่อง?"*
       *"ข้อความข้างต้นสามารถอนุมานได้ตามข้อใด?"*
   - **กรณีเรื่อง "ระดับภาษา" (ภาษาทางการ, กึ่งทางการ, ภาษาปาก/ไม่เป็นทางการ)**:
     - ยกตัวอย่างประโยคจริงครบทั้ง 4 ตัวเลือก แล้วถาม เช่น:
       *"ข้อใดใช้ภาษาระดับทางการได้อย่างถูกต้องเหมาะสมในการทำรายงานราชการ?"*
       *"ข้อความใดต่อไปนี้เป็นภาษาระดับกึ่งทางการ?"*
       *"ข้อใดมีการใช้ภาษาปากปะปนอยู่?"*
   - **กรณีเรื่อง "โครงสร้างประโยค" (ประโยคความเดียว, ความรวม, ความซ้อน, ประโยคบกพร่อง/กำกวม/ฟุ่มเฟือย)**:
     - แต่งประโยคตัวอย่างครบ 4 ตัวเลือก แล้วถาม เช่น:
       *"ข้อใดเป็น 'ประโยคความซ้อน' ที่มีนามานุประโยค?"*
       *"ข้อใดเป็นประโยคที่สื่อความหมายได้ชัดเจน ไม่กำกวม และไม่ใช้คำฟุ่มเฟือย?"*
   - **กรณีเรื่อง "การสะกดคำ การใช้คำ และราชาศัพท์"**:
     - ยกประโยคบริบทจริงที่มีการใช้คำสะกด หรือการใช้คำราชาศัพท์สำหรับพระมหากษัตริย์/พระบรมวงศานุวงศ์/พระสงฆ์
3. 💡 **คำอธิบายเฉลยเจาะลึก (Deep Explanation)**:
   - อธิบายเหตุผลอย่างละเอียด พร้อมยกท่อนข้อความในบทความมาชี้ให้เห็นว่าคำตอบที่ถูกคืออะไร และตัวเลือกอื่นผิดหรือเป็นโวหารชนิดใด

รูปแบบผลลัพธ์: ตอบกลับเฉพาะโครงสร้าง JSON Array ตามรูปแบบนี้เท่านั้น ห้ามมี markdown หรือข้อความอื่น:
[
  {
    "questionText": "ข้อความ:\n\"...แต่งบทความ/ข้อความตัวอย่าง 2-4 บรรทัด...\"\n\nจากข้อความข้างต้น ...คำถาม...",
    "optionA": "ตัวเลือก ก",
    "optionB": "ตัวเลือก ข",
    "optionC": "ตัวเลือก ค",
    "optionD": "ตัวเลือก ง",
    "correctOption": "A",
    "explanation": "คำอธิบายเฉลยอย่างละเอียด อ้างอิงหลักภาษาไทยและการวิเคราะห์บทความ..."
  }
]`;
}
...
function buildSocialPrompt({ count, subcategory, title, contextText }) {
  return `คุณคือผู้เชี่ยวชาญระดับปรมาจารย์ในการออกข้อสอบวิชา "สังคม วัฒนธรรม จริยธรรม และอาเซียน" สำหรับสอบตำรวจ
โปรดสร้างข้อสอบจำนวน ${count} ข้อ ${subcategory ? `เน้นหัวข้อ: "${subcategory}"` : ''} ${title ? `ชื่อชุดข้อสอบ: "${title}"` : ''}
${contextText ? `คลังเนื้อหาอ้างอิง:\n${contextText.substring(0, 16000)}\n\n` : ''}

🎯 โครงสร้างข้อสอบสังคมและจริยธรรมตำรวจจริง:
1. **หลักธรรมทางพระพุทธศาสนาในการครองตน ครองคน ครองงาน**: ทศพิธราชธรรม, อิทธิบาท ๔, สัปปุริสธรรม ๗, พรหมวิหาร ๔, ฆราวาสธรรม ๔, สังคหวัตถุ ๔, หิริ-โอตตัปปะ, อคติ ๔
2. **ประมวลจริยธรรมและจรรยาบรรณของข้าราชการตำรวจ**: ค่านิยมหลักของตำรวจ, จริยธรรมในการใช้อำนาจหน้าที่, ความซื่อสัตย์สุจริต, การไม่เลือกปฏิบัติ, จรรยาบรรณตำรวจ
3. **วัฒนธรรม ประเพณี และประวัติศาสตร์ไทย**: ขนบธรรมเนียมประเพณีประจำชาติและท้องถิ่น, มารยาทไทย, สถาบันหลักของชาติ
4. **ประชาคมอาเซียน (ASEAN Community)**: เสาหลัก 3 เสา (การเมืองและความมั่นคง APSC, เศรษฐกิจ AEC, สังคมและวัฒนธรรม ASCC), กฎบัตรอาเซียน, ประเทศสมาชิก, ความร่วมมือด้านความมั่นคง
5. 💡 **คำอธิบายเฉลย (Deep Explanation)**: อธิบายความหมายของหลักธรรมหรือข้อเท็จจริง และยกตัวอย่างการประยุกต์ใช้ในการปฏิบัติหน้าที่ของตำรวจ
...
[
  {
    ...
    "optionD": "ตัวเลือก ง",
    "correctOption": "A",
    "explanation": "คำอธิบายเฉลยอย่างละเอียด อ้างอิงหลักธรรมและจริยธรรมตำรวจ..."
  }
]`;
}
